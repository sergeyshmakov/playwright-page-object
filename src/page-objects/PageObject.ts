...
export type PageObjectConstructor<TPageObject extends PageObject = PageObject> =
    new (page?: Page, root?: Locator, selector?: SelectorType) => TPageObject;
...
export class PageObject {
    ...
    static isClass<TArgs extends unknown[]>(
        value?: unknown,
    ): value is new (...args: TArgs) => PageObject {
        return (
            typeof value === "function" && value.prototype instanceof PageObject
        );
    }
