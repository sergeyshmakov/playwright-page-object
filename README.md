...
**MCP server.** The package ships a local MCP server that gives AI coding agents static analysis of your page objects and rendered test ids — no grepping, no invented selectors:
