...
- [Choosing a Style](/getting-started/choosing-a-style/) — which pattern to pick.
- [Decorator API](/api/decorators/) — full decorator reference.
- [Troubleshooting](/reference/troubleshooting/) — common resolution errors.
