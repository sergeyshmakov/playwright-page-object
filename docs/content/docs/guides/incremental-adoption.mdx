...
- [Choosing a Style](/getting-started/choosing-a-style/) — when to use each pattern.
- [Plain Classes](/guides/plain-classes/), [Custom Controls](/guides/custom-controls/), [Built-In POM](/guides/built-in-pom/) — the three styles.
