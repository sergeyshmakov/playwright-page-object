...
See the [Fixtures guide](/guides/fixtures/) for factory-function support and shared configuration.
...
- [Choosing a Style](/getting-started/choosing-a-style/) — when to use plain classes vs. fragments vs. built-in POM.
- [Plain Classes guide](/guides/plain-classes/) — deeper coverage of this pattern.
- [Decorator API](/api/decorators/) — full reference for all decorators.
