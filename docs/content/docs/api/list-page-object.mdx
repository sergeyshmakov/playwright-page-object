...
- [Lists guide](/guides/lists/) — walkthrough with examples.
- [Decorator API](/api/decorators/) — `@ListSelector` and `@ListRootSelector` reference.
- [PageObject](/api/page-object/) — base class for item types.
