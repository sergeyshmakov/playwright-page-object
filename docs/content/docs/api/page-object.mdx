...
For root-level page objects, use [`RootPageObject`](/api/root-page-object/) instead.
...
- [RootPageObject](/api/root-page-object/) — the root variant.
- [ListPageObject](/api/list-page-object/) — for repeated children.
