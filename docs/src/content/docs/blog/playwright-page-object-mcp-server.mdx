...
description: "Why AI agents invent Playwright selectors, and how four local MCP tools expose page-object graphs and JSX/TSX test IDs before coding."
head:
  - tag: title
