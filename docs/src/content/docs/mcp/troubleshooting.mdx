...
| was rebuilt | The workspace was released after an idle period, this call analyses a different scope, or a `testDir` / tsconfig edit changed which files the project holds. **Nothing in your test-id sources changed** — re-mint and carry on |
